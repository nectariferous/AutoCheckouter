...
<h4 class="mb-2"><strong>AUTO CHECKER</strong></h4>
...
LIMIT: <span class="badge badge-secondary"> 5000</span><br>
</div>
...
if(total > 30000){
  Swal.fire({title: ':) DARE TO CHECK MORE THAN 30000 CC Ah, Pretty SMALL!!', icon: 'warning', showConfirmButton: false, toast: true, position: 'top-end', timer: 5000});
  return false;
}
